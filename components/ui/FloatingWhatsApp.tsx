...
export default function FloatingWhatsApp() {
  ...
  const whatsappUrl = `https://wa.me/${SITE_CONFIG.whatsapp}?text=Hello%20Mehndi%20Élan!%20I'd%20like%20to%20enquire%20about%20a%20booking.`;
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-6 right-6 z-50 flex items-center gap-3 no-print"
        >
          {/* Tooltip */}
          <AnimatePresence>
            {showTooltip && (
